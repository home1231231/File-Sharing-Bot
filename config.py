...
#Database 
DB_URI = os.environ.get("DATABASE_URL", "mongodb+srv://successspark09:<Dhabale@13>@filestore12.dnbo7vb.mongodb.net/?retryWrites=true&w=majority&appName=filestore12")
